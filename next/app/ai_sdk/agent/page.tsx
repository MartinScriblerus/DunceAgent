  ...
  return (
    <div className="mx-auto w-full max-w-4xl py-12 flex flex-col stretch gap-3">
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        <input
          className="bg-monochrome-dark min-h-screen border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
      ...
      <div
        ...
        // className="flex flex-col gap-2 px-2 h-[650px] overflow-y-auto"
                className="flex flex-col gap-2 px-2 h-[650px]"
      >
        {data.map((item, i) => (
